...
class EntryInventory(Base):
    ...
    on_rent = Column(String, nullable=True)
    vendor_name = Column(String, nullable=True)
    total_rent = Column(String, nullable=True)
    rented_inventory_returned = Column(String, nullable=True)
    returned_date = Column(Date)
    on_event = Column(String, nullable=True)
    in_office = Column(String, nullable=True)
    in_warehouse = Column(String, nullable=True)
